...
import OutlineEffect from "./outline/outline"; // Make sure this file is correctly imported
...
const ReactScene: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Ensure OutlineEffect has a valid reference */}
      {sphereRef.current && (
        <OutlineEffect
          objects={[sphereRef.current]} // Pass the mesh to the outline effect
          outlineColor={"#FFFFFF"} // Set the outline color to white
